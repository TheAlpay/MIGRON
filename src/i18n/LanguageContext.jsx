...
const translations = {
    tr: {
        ...
        points_page_title: "PUAN HESAPLA",
        points_page_subtitle: "Avustralya Skilled Migration — Resmi Points Test",
        points_total_score: "Toplam Puan",
        points_min_threshold: "Minimum Eşik",
        points_see_result: "Sonucu Gör",
        points_see_visa_types: "Vize Türlerini Gör",
        points_checklist: "Kontrol Listesi",
        points_result_excellent: "Mükemmel",
        points_result_excellent_desc: "Davet alma olasılığınız çok yüksek. Çoğu vize kategorisinde önceliklisiniz.",
        points_result_strong: "Güçlü",
        points_result_strong_desc: "70+ puan ile davet alma olasılığınız yüksek. Özellikle 190/491 için uygunsunuz.",
        points_result_ok: "Yeterli",
        points_result_ok_desc: "65 minimum eşiği karşılıyorsunuz. EOI açabilirsiniz ancak davet bekleme süresi uzun olabilir.",
        points_result_insufficient: "Yetersiz",
        points_result_insufficient_desc: "65 puana ulaşmak için ek puan almanız gerekiyor. İngilizce veya Avustralya deneyimi artırın.",
        points_result_low: "Düşük",
        points_result_low_desc: "Skilled göçmenlik için önce puan artırıcı adımlar atmanız gerekiyor.",
        points_disclaimer: "Bu hesaplama, Avustralya İçişleri Bakanlığı'nın resmi puan tablosuna dayanmaktadır. Son doğrulama için",
        points_official_site: "resmi siteyi",
        points_disclaimer_suffix: "ziyaret edin.",
        points_sec_age: "Yaş",
        points_sec_english: "İngilizce Seviyesi",
        points_sec_aus_exp: "Avustralya'da İş Deneyimi",
        points_sec_os_exp: "Yurt Dışı İş Deneyimi",
        points_sec_education: "Eğitim Seviyesi",
        points_sec_partner: "Partner Durumu",
        points_sec_nomination: "Nominasyon",
        points_sec_aus_study: "Avustralya'da Eğitim",
        points_sec_naati: "NAATI Sertifikası",
        points_sec_prof_year: "Professional Year",
    },
    en: {
        // Navbar
        nav_home: "HOME",
        ...
        // Points Calculator Page
        points_page_title: "CALCULATE POINTS",
        points_page_subtitle: "Australia Skilled Migration — Official Points Test",
        points_total_score: "Total Points",
        points_min_threshold: "Minimum Threshold",
        points_see_result: "See Result",
        points_see_visa_types: "View Visa Types",
        points_checklist: "Checklist",
        points_result_excellent: "Excellent",
        points_result_excellent_desc: "Your invitation prospects are very high. You are prioritised in most visa categories.",
        points_result_strong: "Strong",
        points_result_strong_desc: "With 70+ points, your invitation prospects are high. You are well suited for 190/491.",
        points_result_ok: "Sufficient",
        points_result_ok_desc: "You meet the 65-point minimum. You can submit an EOI but wait times may be longer.",
        points_result_insufficient: "Insufficient",
        points_result_insufficient_desc: "You need more points to reach 65. Improve your English or gain Australian work experience.",
        points_result_low: "Low",
        points_result_low_desc: "You need to take steps to boost your points before applying for skilled migration.",
        points_disclaimer: "This calculator is based on the Australian Department of Home Affairs official points table. For final verification, visit the",
        points_official_site: "official website",
        points_disclaimer_suffix: ".",
        points_sec_age: "Age",
        points_sec_english: "English Proficiency",
        points_sec_aus_exp: "Australian Work Experience",
        points_sec_os_exp: "Overseas Work Experience",
        points_sec_education: "Education Level",
        points_sec_partner: "Partner Status",
        points_sec_nomination: "Nomination",
        points_sec_aus_study: "Australian Study",
        points_sec_naati: "NAATI Certificate",
        points_sec_prof_year: "Professional Year",
    }
};

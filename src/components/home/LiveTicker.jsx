...
const COST_ITEMS = {
    tr: [
        { label: 'Sydney Kira (1+1)', value: '~$2.400/ay', city: 'SYD' },
        { label: 'Melbourne Kira (1+1)', value: '~$2.050/ay', city: 'MEL' },
        { label: 'Brisbane Kira (1+1)', value: '~$2.000/ay', city: 'BNE' },
        { label: 'Perth Kira (1+1)', value: '~$2.100/ay', city: 'PER' },
        { label: 'Haftalık Market (2 kişi)', value: '$190–230', city: 'AUS' },
        { label: 'Benzin (unleaded)', value: '~$1.78/L', city: 'AUS' },
        { label: 'Ulaşım (aylık)', value: '~$170', city: 'SYD' },
        { label: 'Restoran (2 kişi)', value: '~$100–130', city: 'AUS' },
        { label: 'Elektrik+Su (aylık)', value: '~$220–300', city: 'AUS' },
        { label: 'Asgari Ücret', value: '$24.10/saat', city: 'AUS' },
        { label: 'Ort. Tam Zamanlı Maaş', value: '~$2.100/hafta', city: 'AUS' },
        { label: 'Kahve (flat white)', value: '$5–7', city: 'AUS' },
        { label: 'Bira (400ml pub)', value: '~$11–14', city: 'AUS' },
        { label: 'Gym Üyeliği (aylık)', value: '~$50–90', city: 'AUS' },
        { label: 'Üniversite (yıllık)', value: '$25.000–55.000', city: 'AUS' },
    ],
    en: [
        { label: 'Sydney Rent (1BR)', value: '~$2,400/mo', city: 'SYD' },
        { label: 'Melbourne Rent (1BR)', value: '~$2,050/mo', city: 'MEL' },
        { label: 'Brisbane Rent (1BR)', value: '~$2,000/mo', city: 'BNE' },
        { label: 'Perth Rent (1BR)', value: '~$2,100/mo', city: 'PER' },
        { label: 'Weekly Groceries (2 ppl)', value: '$190–230', city: 'AUS' },
        { label: 'Petrol (unleaded)', value: '~$1.78/L', city: 'AUS' },
        { label: 'Public Transport (mo)', value: '~$170', city: 'SYD' },
        { label: 'Restaurant (2 people)', value: '~$100–130', city: 'AUS' },
        { label: 'Electricity+Water (mo)', value: '~$220–300', city: 'AUS' },
        { label: 'Minimum Wage', value: '$24.10/hr', city: 'AUS' },
        { label: 'Avg. Full-Time Salary', value: '~$2,100/wk', city: 'AUS' },
        { label: 'Coffee (flat white)', value: '$5–7', city: 'AUS' },
        { label: 'Beer (400ml pub)', value: '~$11–14', city: 'AUS' },
        { label: 'Gym Membership (mo)', value: '~$50–90', city: 'AUS' },
        { label: 'University (annual)', value: '$25,000–55,000', city: 'AUS' },
    ],
};
